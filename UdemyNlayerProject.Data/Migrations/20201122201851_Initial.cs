...
namespace UdemyNlayerProject.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "InnerBarcode", "IsDeleted", "Name", "Price", "StockCode" },
                values: new object[,]
                {
                    { 4, 2, null, false, "Küçük Defter", 12.50m, 100 },
                    { 5, 2, null, false, "Orta Boy Defter", 12.50m, 100 },
                    { 6, 2, null, false, "BüyükBoy Defter", 12.50m, 100 },
                    { 1, 1, null, false, "Plot kalem", 12.50m, 100 },
                    { 2, 1, null, false, "Kurşun kalem", 12.50m, 100 },
                    { 3, 1, null, false, "Tükenmez kalem", 12.50m, 100 }
                });
